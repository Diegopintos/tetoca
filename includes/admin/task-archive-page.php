...
function tetoca_add_task_page() {
    ...
    if (isset($_POST['tetoca_nonce']) && wp_verify_nonce($_POST['tetoca_nonce'], 'tetoca_add_task')) {
        // Procesar el formulario aquí
        // ...
    }

    // Mostrar mensajes de error o éxito
    settings_errors('tetoca_messages');
    ...
    <div class="wrap">
        ...
        <form method="post" enctype="multipart/form-data">
            <?php $nonce = wp_create_nonce('tetoca_add_task'); ?>
            <input type="hidden" name="tetoca_nonce" value="<?php echo esc_attr($nonce); ?>">
...
add_action('admin_menu', 'tetoca_add_admin_page');
function tetoca_add_admin_page() {
